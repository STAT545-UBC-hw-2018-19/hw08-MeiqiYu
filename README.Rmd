...
This repo is the Hw08 for STAT547M. In this assignment, I added some extra features to BC Liquor shiny app and deployed it.

# Quick Link

Here is the [link](https://maggieyumq.shinyapps.io/bcl_meiqiyu/) of my shiny app.

Here is the [link](https://github.com/STAT545-UBC-students/hw08-MeiqiYu/blob/master/bcl_meiqiyu/app.R) of the R code.
